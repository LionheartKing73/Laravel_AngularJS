...
class User extends Model implements AuthenticatableContract {
     ...
     */
    protected $fillable = [
        'role_id', 'username', 'email', 'password', 'available_wallet_amount', 'blocked_amount', 'item_count', 'item_user_count', 'user_login_count', 'user_view_count', 'is_agree_terms_conditions', 'is_active', 'is_email_confirmed', 'register_ip_id', 'last_login_ip_id', 'user_avatar_source_id','overall_rating_count','user_review_count', 'bedside_rating_count', 'bedside_avg_rating', 'timing_rating_count', 'timing_avg_rating', 'overall_rating_count', 'overall_avg_rating', 'user_rating_count', 'is_trial', 'subscription_id', 'subscription_end','device_type','device_token','is_paypal_suspend', 'is_paypal_cancel', 'is_expiry', 'otp', 'is_otp_verify', 'mobile'
    ];
