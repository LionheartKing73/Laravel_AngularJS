...
class AppointmentModificationsController extends Controller {
    ...
    public function update(Request $request, $modifiedId){
        ...
        */
        $acceptFields = $request->only('appt_time', 'type', 'is_active');
        /* For get the Auth */
        $user = $this->auth->user();
        //print_r($acceptFields); die;
    ...
    public function add(Request $request){
        $acceptFields = $request->only('appoint_date', 'appt_time', 'type', 'is_active');
        /* For get the Auth */
        $user = $this->auth->user();
        ...
        if(!empty($acceptFields['appoint_date'])){
            ...
            $isDateAlreadyAdded = AppointmentModifications::where(['user_id'=>$user->id,'appoint_date'=>$acceptFields['appoint_date']])->first();
