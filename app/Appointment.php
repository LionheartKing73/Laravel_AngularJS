...
class Appointment extends Model {
     ...
     */
    protected $fillable = [
        'user_id', 'doctor_user_id', 'appointment_date', 'appointment_time', 'phone', 'patient_note', 'doctor_note', 'first_name', 'last_name', 'postal_code', 'dob', 'gender_id', 'is_guest_appointment', 'guest_first_name', 'guest_last_name', 'guest_email', 'guest_postal_code', 'guest_dob', 'guest_gender_id', 'specialty_disease_id', 'is_seen_before', 'appointment_status_id', 'is_offline_booking', 'preference_type_id','is_widget_booking', 'widget_id', 'is_ical_booking', 'ical_link_id', 'is_ical_booking'
    ];
