...
class AppointmentModificationsTransformer extends Fractal\TransformerAbstract {
    ...
    public function transform(AppointmentModifications $appointmentModifications) {
        $output = array_only($appointmentModifications->toArray(), ['id','user_id', 'appoint_date', 'is_two_session', 'practice_open', 'lunch_at', 'resume_at', 'practice_close', 'type', 'is_active',]);
        return $output;
    }
